		...
		if self.__start_track == True:
			...
			if self.__reset == True:
				...
				if self.__tracking_marker2 != 0:
					...
					if self.__markers[self.__tracking_marker2][0][0][0] is not None:
						...
						if length >=0.01 or length <=-0.01:
							print 'tracking list updated '
							marker_toadd = deepcopy(self.__markers[self.__tracking_marker2][0])
							self.__markers2[self.__tracking_marker2].append(marker_toadd)
							print len(self.__markers2[self.__tracking_marker2])
