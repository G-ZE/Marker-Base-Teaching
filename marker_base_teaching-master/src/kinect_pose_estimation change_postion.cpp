...
int main (int argc, char** argv){
	...
	*/
	...
	while (true){
	    ...
	    std::cout <<"Time taken for image retrieve : "<< endtimer - starttimer <<std::endl;
	    ...
	    endtimer =ros::Time::now().toSec();
	    std::cout <<"Time taken for pcl retrieve : "<< endtimer - starttimer <<std::endl;
